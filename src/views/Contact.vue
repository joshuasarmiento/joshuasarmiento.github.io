    ...
    <div class="text-primary flex flex-col gap-16 md:gap-24">
        ...
        <ul class="flex-grow grid grid-cols-1 gap-2 lg:gap-3 animated-list animate-in mx-6" style="--index: 3;">
            <li v-for="data in connectLinks" :key="data.id" class="col-span-1">
                <a :class="data.animateDelay" class="animate-fade-up text-sm relative underline-offset-4 overflow-hidden transition-opacity no-underline w-full border rounded-lg p-4 border-primary inline-grid group" target="_blank" href="mailto:sarmientojoshuaalvarez@gmail.com">
