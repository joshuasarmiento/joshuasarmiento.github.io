  ...
  <section>
    <div class="flex flex-col gap-8 animate-in mt-16 p-4">
        ...
        <div class="">
            ...
            <p class="text-secondary animate-fade-up animate-delay-[100ms]" style="--index:1">{{  subject }}</p>
        </div>
        ...
        <!-- Description -->
        <p class="text-primary max-w-lg animate-fade-up animate-delay-[300ms]" style="--index:2">
            {{ description }}
        </p>
        <!-- Links -->
        <LinksSection/>
...
const links = ref([
    ...
    {
        id: 2,
        text: '1+ Experience ﹥ 5+ Projects',
        svg: `<svg viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
