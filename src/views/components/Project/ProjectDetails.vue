    ...
    <div class="flex flex-col gap-20">
        <article>
            ...
            <div class="animate-fade-up animate-delay-[500ms]">
                <h2 class="text-xl font-bold tracking-tight mb-4">Tools and Techhnologies Used</h2>
            ...
            <div class="animate-fade-up animate-delay-[600ms]">
                <h2 class="text-xl font-bold tracking-tight mb-4">Challenge</h2>
                <p v-for="chal in project.challenge" :key="chal" class="pb-4">{{ chal }}</p>
            </div>
            <div v-if="data.liveLink" class="h-8"></div>
            <a v-if="data.liveLink" class="group relative inline-flex items-center overflow-hidden rounded border border-current px-4 lg:px-8 py-2" target="_blank" :href="data.liveLink">
                            ...
                            <div class="flow-root">
                                <ul class="-m-1 flex flex-wrap">
                                    <li v-if="contri.link" class="p-1 leading-none">
                                        <a :href="contri.link" class="text-xs font-medium"> Contact </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
