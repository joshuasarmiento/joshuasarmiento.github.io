<template>
<section v-if="dataUIUX" class=" mt-8 md:mt-16 scroll-smooth">
    <div class="flex flex-col gap-20">
        <article>
            ...
            <div class="animate-fd-3">
                <iframe loading="lazy" style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" class="w-[calc(100%+48px)] -ml-6 lg:w-[calc(100%+128px)] lg:-ml-16 md:rounded-lg max-w-none" :src="dataUIUX.embedLink" allowfullscreen></iframe>
            </div>
            ...
            <div class="h-8"></div>
            <a class="animate-fd-6 group relative underline-offset-4 inline-flex items-center overflow-hidden rounded border border-current px-8 py-3" target="_blank" :href="dataUIUX.embedLink">
