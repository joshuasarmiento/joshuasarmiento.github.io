<template>
    <section v-if="data" class=" mt-8 md:mt-16">
        <div class="flex flex-col gap-20">
            <article>
                ...
                <div v-if="data.embedLink" class="animate-fade-up animate-delay-[600ms]">
                    <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" class="w-[calc(100%+48px)] -ml-6 lg:w-[calc(100%+128px)] lg:-ml-16 md:rounded-lg max-w-none" :src="data.embedLink" allowfullscreen></iframe>
                </div>
                ...
                <div v-if="project.poster" class="animate-fade-up animate-delay-[800ms]">
                ...
                <a v-if="data.liveLink" class="animate-fade-up animate-delay-[900ms] group relative underline-offset-4 inline-flex items-center overflow-hidden rounded border border-current px-8 py-3" target="_blank" :href="data.liveLink">
                ...
                <div v-if="data.contributors" class="animate-fade-up animate-delay-[1000ms] border border-neutral-500 rounded-md p-4 w-[calc(100%+48px)] -ml-6 lg:w-[calc(100%+128px)] lg:-ml-16 ">
