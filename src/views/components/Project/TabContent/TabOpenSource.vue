            ...
            <div class="animate-fade-up">
                <div class="flex justify-between gap-6 items-center">
                    ...
                    <section class="flex flex-col items-start md:items-center md:flex-row gap-2 md:gap-9 col-reverse">
                        ...
                        <span class="cursor-auto text-secondary" v-if="itemOS.isEmpty" >{{ itemOS.subject }}</span>
                        <div v-else>
                    ...
                    <span v-if="itemOS.isOngoing" class="inline-flex items-center justify-center rounded-full bg-amber-600/30 dark:bg-amber-100/30 backdrop-blur-sm px-2.5 py-0.5 dark:text-amber-100 text-amber-700">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="-ms-1 me-1.5 h-3 w-3">
                            ...
                            <p class="whitespace-nowrap text-xs">Ongoing</p>
                        </span>
                </div>
            </div>
        </li>
